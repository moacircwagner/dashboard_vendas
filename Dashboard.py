...
# entrar na pasta onde está o código > cd venv
# antes de rodar, inicializar o sistema com o comando: streamlit run Dashboard.py
...
if todos_anos:
    ...
    ano = st.sidebar.slider('Ano', 2018, 2021)
